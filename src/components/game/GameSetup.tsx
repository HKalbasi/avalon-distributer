    ...
    <div className='bg-white rounded-2xl shadow-lg p-6 mb-6 border border-[#bdc3c7]/20'>
      ...
      <div>
        ...
        <div className='flex gap-2'>
          ...
          />
          <button className='btn btn-custom-primary' onClick={() => setSeed(makeid(4))}>
            Generate
          </button>
        </div>
        <p className='text-xs text-[#bdc3c7] mt-2'>All players must use the same seed to get matching roles</p>
      </div>
    </div>
  )
}
